...
/* 17. Age */
    ...
    save "$root/01_try_pyth_v9.dta", replace
...
/* 26. Merge on individual data */
    use "$root/ind2023er/ind2023er.dta", clear
    g ID = fam * 1000 + ER30002
    
    merge 1:m ID using "$root/01_heads_kids_panel_v9.dta", generate(new_merge)
    drop if yr == .
...
/* 27. Clean up  */
    ...
    save "$root/01_kids_panel_v9.dta", replace
