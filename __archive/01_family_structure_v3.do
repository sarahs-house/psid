...
/* 03. Population born between 1968 and 2007*/
    ...
    * keep only families with children born 1968-2007
    drop if max_temp == 1
    ...
    drop ER30002 
    save "$out_2023/qualified_families_v3.dta", replace

    local qualified "$out_2023/qualified_families_v3.dta"
...
/* Save */
    save "01_family_structure_v3.dta", replace

/* Merge on Individual Data */
    clear
    use "$root/ind2023er/qualified_families_v3.dta"
    joinby ER30001 using"$root/ind2023er/ind2023er.dta"
    g yr = 1968
    ...
    clear
    use "01_family_structure_v3.dta" 
    g ER30002 = 1
    g ID = ER30001 * 1000 + ER30002
    drop ER30002
    ...
    replace ER30001 = ID/1000 if ER30001 == .
    replace ER30001 = round(ER30001, 1.0)

    sort ER30001 yr ER30002 

/* Save */
    save "$root/01_family_panel_v3.dta", replace
