...
/* 00. Program Set Up */
    ...
    log using "$root/_log/01_family_structure_v9_`datetime'.log", replace
...
/* 12. Save family composition file */
    save "$root/01_family_structure_v9.dta", replace
    ...
    save "$root/01_qualified_kids_v9.dta", replace
...
/* 13. Individual file */
    ...
    merge 1:m ID using "01_qualified_kids_v9.dta"
...
/* 19. Save hh roster time series */
        ...
        save "$root/01_hhr_v9.dta", replace
        collapse ID, by(fam)
        drop ID 
        save "$root/01_qualified_families_v9.dta", replace
...
/* ------------------------------------- */
    ...
    local qualified "$root/01_qualified_families_v9.dta"
    use "`qualified'"
...
/* 21. Merge together */
    ...
    *append using "$root/fam2021er/fam2021_qualifiedsample.dta"
    ...
    save "$root/01_heads_panel_v9.dta", replace

/* 22. Merge on Household Roster Data */
    append using "$root/01_hhr_v9.dta"
...
/* 24. Save final dataset */
    save "$root/01_heads_kids_panel_v9.dta", replace
