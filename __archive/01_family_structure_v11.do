...
/* 00. Program Set Up */
    ...
    log using "$root/_log/01_family_structure_v11_`datetime'.log", replace
    ...
    * Switches
    ...
    local qualified "$root/01_qualified_families_v11.dta"
...
* n = 309,602 observations/person-waves
    * i = 33,578 unique individuals
        * minus 2,816 individuals only observed once = 30,762 
...
if `part1' == 1 {
    ...
    /* 12. Save family composition file */
        save "$root/01_family_structure_v11.dta", replace
        ...
        save "$root/01_qualified_kids_v11.dta", replace
...
if `part2' == 1{
    /* 13. Individual file */
        ...
        merge 1:m ID using "01_qualified_kids_v11.dta"
    ...
    /* 15. Annual HH Roster */
        ...
        preserve
            ...
            /* 16. Ages of people in annual HH roster (create variables ages1968, ages1969, ..., ages2023) */
            ...
            * remove leading commas/spaces from ages_* string variables
            ...
            keep in_* hh* ages* birth_year fam fam_number ID kid_sample yr_first_observed yr_last_observed bio_mom_id bio_dad_id a_mom_id a_dad_id bio_md_ever_together


    /* 16. Reshape */
            reshape long hhr_ ages, i(ID) j(yr)
    ...
    /* 17. Age */
        ...
        save "$root/01_try_pyth_v11.dta", replace

        clear

    /* 18. Identify changes in hhr */
    * I do this in python file, final_data_v1.ipynb * 
    import delimited "final_data_v1.csv"
    save "$root/01_hhr_v11.dta", replace
    rename id ID 
    collapse ID, by(fam)
    drop ID 
    save "$root/01_qualified_families_v11.dta", replace
...
if `part3' == 1{
    ...
    /* 21. Merge together */
        ...
        *append using "$root/fam2021er/fam2021_qualifiedsample.dta"
        ...
        save "$root/01_heads_panel_v11.dta", replace

    /* 22. Merge on Household Roster Data */
        append using "$root/01_hhr_v11.dta"
    ...
    /* 25. Save */
        save "$root/01_heads_kids_panel_v11.dta", replace
}


/* ------------------------------------- */
* PART IV: merge on individual data and clean
/* ------------------------------------- */
...
if `part4' == 1{
    ...
    /* 26. Merge on individual data */
        ...
        merge 1:m ID using "$root/01_heads_kids_panel_v11.dta", generate(new_merge)
        drop if yr == .
    ...
    *drop if age >= 19
    ...
    order kid_sample fam ID yr age race sex head_ed FU_income who_left who_came ages_left ages_came adult_came adult_left n_adults_left n_adults_came
    ...
    * Years of education completed 
        ...
        replace school_completed = ER30051 if yr == 1970
        replace school_completed = ER30076 if yr == 1971
        replace school_completed = ER30110 if yr == 1972
...
if `part5' == 1{
    drop if kid_sample != 1
    keep fam ID yr age race indiv_weight sex head_ed FU_income who_left who_came ages_left ages_came adult_came adult_left n_adults_left n_adults_came hhr_ ages fam_number mom_marital_birth birth_year bio_mom_id bio_dad_id a_mom_id a_dad_id bio_md_ever_together yr_first_observed yr_last_observed hhr_prev ages_prev child_came child_left head_ed_cat no_adults family_weight family_size no_in no_out who_in who_out rent homevalue own_rent head_mar age_head sex_head region state fu_change adult_change head_rel stopped_ed school_completed
    ...
    label var birth_year "Year of birth of individual"
    label var bio_mom_id "Biological Mother's ID"
    label var bio_dad_id "Biological Father's ID"
    label var a_mom_id "Adoptive Mother's ID"
    label var a_dad_id "Adoptive Father's ID"
...
/* 
1968: ER30010, years of school completed

stop, grade 

    1969: ER30028
    1970: ER30052 ER30051
    1971: ER30075 ER30076
    1972: ER30099 ER30110
    1973: ER30125 ER30126 
    1974: ER30146 ER30147
    1975: ER30168 ER30169
    1976: ER30196 ER30197
    1977: ER30225 ER30226
    1978: ER30254 ER30255



k4 student, k48 # wks in school, k49 education
    1979: ER30294 ER30295 ER30296

ind a student?, weeks in school (k51)?, education attained
    1980: ER30324 ER30325 ER30326

whether student, # weeks in school, completed educ
    1981: ER30354 ER30355 ER30356

Whether student, completed education
    1982: ER30383 ER30384
    1983: ER30412 ER30413
    1984: ER30442 ER30443

F88 mo last in sch, f88 yr last in sch, whether student, completed education
    1985: ER30475 ER30476 ER30477 ER30478
    1986: (G88) ER30510 ER30511 ER30512 ER30513
    1987: ER30546 ER30547 ER30548 ER30549
    1988: ER30581 ER30582 ER30583 ER30584
    1989: ER30617 ER30618 ER30619 ER30620
    1990: ER30654 ER30655 ER30656 ER30657
    1991: ER30700 ER30701 ER30702 ER30703
    1992: ER30745 ER30746 ER30747 ER30748
    1993: ER30817 ER30818 ER30819 ER30820
    1994: ER33112 ER33113 ER33114 ER33115
    1995: ER33212 ER33213 ER33214 ER33215
    1996: ER33312 ER33313 ER33314 ER33315
    1997: ER33412 ER33413 ER33414 ER33415
    1999: ER33513 ER33514 ER33515 ER33516
    2001: ER33613 ER33614 ER33615 ER33616
    2003: ER33713 ER33714 ER33715 ER33716
    2005: ER33814 ER33815 ER33816 ER33817
    2007: ER33914 ER33915 ER33916 ER33917
    2009: ER34017 ER34018 ER34019 ER34020

month last in school, year last in school, years completed education
    2011: ER34117 ER34118 ER34119

month, year, highest grade, hs y/n, type highest degree, month grad bach, year grad bach, bach major, month grad highest degree, year grad highest degree, highest degree major, current student?, grade copmleted, years completed education
    2013: ER34217 ER34218 ER34219 ER34220 ER34221 ER34222 ER34223 ER34224 ER34225 ER34226 ER34227 ER34228 ER34229 ER34230
...
labor, asset, transfer
    1993: ER30821 ER30822 ER30825
