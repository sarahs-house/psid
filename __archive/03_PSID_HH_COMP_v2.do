...
/* 04. Population born between 1978 and 1996*/
...
/* 03 Pull data from survey waves 1978-1991 */
    /*  1978 survey */
        clear
        ...
        * keep qualified families only
        ...
        drop _merge
        save "fam1978_qualifiedsample.dta", replace
    ...
    /* 1979 survey */
        ...
        order ER30001 _merge
            ...
            * keep qualified families only
            ...
            cd "/Users/sarsul/Desktop/psid/fam1979"
            g yr = 1979
            save "fam1979_qualifiedsample.dta", replace
    ...
    merge m:1 ER30001 using `qualified'
        * keep qualified families only
        ...
        keep if qualified_family == 1
        g yr=1980
        save "fam1980_qualifiedsample.dta", replace
    ...
    merge m:1 ER30001 using `qualified'
        * keep qualified families only
        ...
        keep if qualified_family == 1
        g yr =1981
        save "fam1981_qualifiedsample.dta", replace
    ...
    merge m:1 ER30001 using `qualified'
        * keep qualified families only
        ...
        keep if qualified_family == 1
        g yr=1982
        save "fam1982_qualifiedsample.dta", replace
    ...
    merge m:1 ER30001 using `qualified'
        * keep qualified families only
        ...
        keep if qualified_family == 1
        g yr=1983
        save "fam1983_qualifiedsample.dta", replace
    ...
    merge m:1 ER30001 using `qualified'
        * keep qualified families only
        ...
        keep if qualified_family == 1
        g yr=1984
        save "fam1984_qualifiedsample.dta", replace
    ...
    merge m:1 ER30001 using `qualified'
        * keep qualified families only
        ...
        keep if qualified_family == 1
        g yr=1985
        save "fam1985_qualifiedsample.dta", replace
    ...
    merge m:1 ER30001 using `qualified'
        * keep qualified families only
        ...
        keep if qualified_family == 1
        g yr=1986
        save "fam1986_qualifiedsample.dta", replace
    ...
    merge m:1 ER30001 using `qualified'
        * keep qualified families only
        ...
        keep if qualified_family == 1
        g yr = 1987
        save "fam1987_qualifiedsample.dta", replace
    ...
    merge m:1 ER30001 using `qualified'
        * keep qualified families only
        ...
        keep if qualified_family == 1
        g yr=1988
        save "fam1988_qualifiedsample.dta", replace
    ...
    merge m:1 ER30001 using `qualified'
        * keep qualified families only
        ...
        keep if qualified_family == 1
        g yr=1989
        save "fam1989_qualifiedsample.dta", replace
    ...
    merge m:1 ER30001 using `qualified'
        * keep qualified families only
        ...
        keep if qualified_family == 1
        g yr=1990
        save "fam1990_qualifiedsample.dta", replace
    ...
    merge m:1 ER30001 using `qualified'
        * keep qualified families only
        ...
        keep if qualified_family == 1
        g yr=1991
        save "fam1991_qualifiedsample.dta", replace
...
/* Merge all waves together 
    ...
    * 1978-1980
    use "/Users/sarsul/Desktop/psid/fam1980/fam1980_qualifiedsample.dta"
